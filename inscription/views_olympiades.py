...
def olympiades_demande_lien(request: HttpRequest) -> HttpResponse:
    ...
    if request.method == "POST" and form.is_valid():
        ...
        corps: str = (
            "Bonjour,\n\n"
            "Vous avez demandé un lien d’accès au portail d’inscription des Olympiades de NSI.\n\n"
            "Ce lien est personnel et associé à cette adresse email. "
            "Il permet d’accéder à un portail permettant :\n"
            " - d'inscrire un établissement aux Olympiades de NSI ;\n"
            " - de consulter, modifier ou supprimer une inscription déjà effectuée.\n\n"
            f"Lien d’accès au portail :\n{lien}\n\n"
            "Ce lien est valable pendant 24 heures.\n"
            "Une fois expiré, il suffit de refaire une demande de lien depuis le formulaire "
            "d’inscription pour y accéder à nouveau.\n\n"
            "Nous vous remercions pour l’intérêt que vous portez aux Olympiades de NSI.\n\n"
            "Cordialement,\n"
